# Contributing to SuperMQ and Magistrala Python SDK

This Python SDK provides client libraries for both [SuperMQ](https://github.com/absmach/supermq) and [Magistrala](https://github.com/absmach/magistrala), which are
...
list](https://github.com/absmach/supermq-sdk-py/issues) to determine if it already contains the
...
Please adhere to the coding conventions used throughout the project. For Python code, follow [PEP 8](https://pep8.org/) style guide.

To contribute to the project, [fork](https://help.github.com/articles/fork-a-repo/) it,
clone your fork repository, and configure the remotes:

```bash
git clone https://github.com/<your-username>/supermq-sdk-py.git
cd supermq-sdk-py
git remote add upstream https://github.com/absmach/supermq-sdk-py.git
```
