...
class NotifiersApi(object):
    ...
    def create_subscription(self, body, **kwargs):  # noqa: E501
        ...
        Creates a new subscription give a topic and contact.  # noqa: E501
        ...
        :param CreateSubscription body: JSON-formatted document describing the new subscription to be created (required)
        :return: None
    ...
    def list_subscriptions(self, **kwargs):  # noqa: E501
        ...
        List subscriptions given list parameters.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param str contact: Subscription contact.
    ...
    def list_subscriptions_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['topic', 'contact', 'offset', 'limit']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def remove_subscription(self, id, **kwargs):  # noqa: E501
        ...
        Removes a subscription with the provided id.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.remove_subscription(id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str id: Unique identifier. (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def remove_subscription_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.remove_subscription_with_http_info(id, async_req=True)
        >>> result = thread.get()
    ...
    def view_subscription(self, id, **kwargs):  # noqa: E501
        """Get subscription with the provided id  # noqa: E501

        Retrieves a subscription with the provided id.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.view_subscription(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.view_subscription_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.view_subscription_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def view_subscription_with_http_info(self, id, **kwargs):  # noqa: E501
        """Get subscription with the provided id  # noqa: E501

        Retrieves a subscription with the provided id.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.view_subscription_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method view_subscription" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `view_subscription`")  # noqa: E501
